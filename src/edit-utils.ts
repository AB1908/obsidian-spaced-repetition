...
export function replacedCardText(front: string, card: CardInterface, cardText: string, questionText: string, back: string, answerText: string, isCardCommentOnSameLine: boolean) {
