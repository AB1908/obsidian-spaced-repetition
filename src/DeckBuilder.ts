...
function singleLineBasicSiblingMatches(cardText: string, settings: SRSettings): [string, string] {
...
function multiLineBasicSiblingMatches(cardText: string, settings: SRSettings): [string, string] {
...
function multiLineReversedSiblingMatches(cardText: string, settings: SRSettings): [string, string][] {
