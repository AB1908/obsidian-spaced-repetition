import type {CardInterface} from "src/scheduling";
...
test("removal", () => {
    ...
    expect(replacedCardText(front, card as unknown as CardInterface, cardText, questionText, back, answerText, false)).toEqual(expectedOutput);
})
