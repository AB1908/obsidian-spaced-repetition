...
## Depends on
- [BUG-009](../archive/stories/BUG-009-import-annotation-editor-state-leak.md) (state reset must work)
- [STORY-025](../archive/stories/STORY-025-category-editor-modal.md) (category management UX must be settled before wiring immediate save)
